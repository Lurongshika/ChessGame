...
const PERKS_NORMAL := [
	...
	{"id": "shenpan", "name": "审判", "tip": "被动", "desc": "己方子吃子时无视敌方棋子所携带效果(无敌/保护/禁吃等)", "cat": "全局"},
...
const PERKS_ADVANCED := [
	...
	{"id": "huanghou2", "name": "皇后·逆位", "tip": "主动 · 被吃充能3", "desc": "所有棋子获得反制持续1回合(被吃时与对方同归于尽)", "cat": "全局"},
	...
	{"id": "zhanche2", "name": "战车·逆位", "tip": "主动 · 3回合", "desc": "通过车相邻子(含敌方)的落位移动车", "cat": "全局"},
	...
	{"id": "liliang2", "name": "力量·逆位", "tip": "被动", "desc": "主动技能充能上限-1/4(四舍五入)", "cat": "全局"},

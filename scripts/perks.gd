...
const PERKS_NORMAL := [
	...
	{"id": "nvjisi", "name": "女祭司", "tip": "主动 · 3回合", "desc": "在我方兵线随机位置生成一个兵", "cat": "全局"},
	{"id": "huanghou", "name": "皇后", "tip": "主动 · 被吃充能3", "desc": "所有棋子获得无敌(下回合生效)", "cat": "全局"},
	{"id": "huangdi", "name": "皇帝", "tip": "主动 · 3回合", "desc": "指定己方一子本回合无敌", "cat": "全局"},
	{"id": "jiaohuang", "name": "教皇", "tip": "被动 · 象强化", "desc": "象落位处的己方棋子获得无敌", "cat": "棋子"},
	{"id": "lianren", "name": "恋人", "tip": "被动", "desc": "每被吃两个子可以复活一子到同类棋子出生位置,位置全部被占则不可复活", "cat": "全局"},
	{"id": "zhanche", "name": "战车", "tip": "主动 · 3回合", "desc": "指定车相邻一子,落至该车所能落位", "cat": "全局"},
	{"id": "zhengyi", "name": "正义", "tip": "被动 · 马强化", "desc": "马不会被别马腿,可跳过阻挡,可跳至另一马所能落位", "cat": "棋子"},
	{"id": "yinzhe", "name": "隐者", "tip": "主动 · 4回合", "desc": "下回合移动的子隐身一回合,隐身子无法攻击", "cat": "全局"},
	{"id": "mingyun", "name": "命运之轮", "tip": "主动 · 4回合", "desc": "该回合可额外移动一次(不能连续动同一子)", "cat": "全局"},
	{"id": "liliang", "name": "力量", "tip": "被动", "desc": "主动技能充能上限-1", "cat": "全局"},
	{"id": "diaodiao", "name": "倒吊人", "tip": "主动 · 2回合", "desc": "获得对方一枚棋子控制权一回合(下回合生效)", "cat": "全局"},
	...
	{"id": "ta", "name": "塔", "tip": "被动 · 开局生效", "desc": "开局额外获得四枚兵;兵过河后可斜向前吃子", "cat": "全局"},
	{"id": "xingxing", "name": "星星", "tip": "被动 · 每回合一次", "desc": "每回合一次,兵/卒可无代价向后移动一格(不消耗行动)", "cat": "棋子"},
	{"id": "yueliang", "name": "月亮", "tip": "被动 · 象强化", "desc": "象的移动距离不受限制", "cat": "棋子"},
	{"id": "taiyang", "name": "太阳", "tip": "被动 · 车强化", "desc": "车可以斜走一格", "cat": "棋子"},
	{"id": "shenpan", "name": "审判", "tip": "被动", "desc": "每回合随机禁用敌方一个技能", "cat": "全局"},
	{"id": "shijie", "name": "世界", "tip": "被动", "desc": "每回合每个己方棋子都会有25%概率变为任意棋子(将帅除外)", "cat": "全局"},
]

# 进阶版技能池(22 个)
const PERKS_ADVANCED := [
	{"id": "yuzhe2", "name": "愚者·逆位", "tip": "主动 · 16回合(开局充能)", "desc": "复原所有棋子位置(不复活被吃子)", "cat": "全局"},
	{"id": "moshushi2", "name": "魔术师·逆位", "tip": "主动 · 6回合", "desc": "交换敌方两子的位置", "cat": "全局"},
	{"id": "nvjisi2", "name": "女祭司·逆位", "tip": "主动 · 7回合", "desc": "在我方底线随机位置生成一个随机棋子", "cat": "全局"},
	{"id": "huanghou2", "name": "皇后·逆位", "tip": "主动 · 被吃充能3", "desc": "所有棋子获得反制(被吃时与对方同归于尽)", "cat": "全局"},
	{"id": "huangdi2", "name": "皇帝·逆位", "tip": "主动 · 3回合", "desc": "指定己方一子获得反制(被吃时同归于尽)", "cat": "全局"},
	{"id": "jiaohuang2", "name": "教皇·逆位", "tip": "被动 · 象强化", "desc": "象落位处的己方棋子获得反制(被吃时同归于尽)", "cat": "棋子"},
	{"id": "lianren2", "name": "恋人·逆位", "tip": "被动", "desc": "每被吃五个子随机摧毁对方三个子", "cat": "全局"},
	{"id": "zhanche2", "name": "战车·逆位", "tip": "主动 · 3回合", "desc": "车能落至相邻子(不含对角)可以落位的位置", "cat": "全局"},
	{"id": "zhengyi2", "name": "正义·逆位", "tip": "主动 · 2回合", "desc": "炮吃子变为隔两子,使用技能后在隔一二子间切换", "cat": "棋子"},
	{"id": "yinzhe2", "name": "隐者·逆位", "tip": "主动 · 12回合", "desc": "敌我所有子进入隐身三回合", "cat": "全局"},
	{"id": "mingyun2", "name": "命运之轮·逆位", "tip": "主动 · 6回合", "desc": "随机两子进入协同状态(不消耗步数)", "cat": "全局"},
	{"id": "liliang2", "name": "力量·逆位", "tip": "被动", "desc": "主动技能充能上限-1/3", "cat": "全局"},
	{"id": "diaodiao2", "name": "倒吊人·逆位", "tip": "主动 · 9回合", "desc": "获得对方棋子控制权连续三回合,该三回合内不能吃子", "cat": "全局"},
	...
	{"id": "emo2", "name": "恶魔·逆位", "tip": "被动", "desc": "敌方吃子后我方对其他类型棋子攻击全部免疫,直到2回合后或同类型子再次吃子", "cat": "全局"},
	{"id": "ta2", "name": "塔·逆位", "tip": "被动 · 开局生效", "desc": "开局失去所有兵;我方所有子可八向移动一格", "cat": "全局"},
	{"id": "xingxing2", "name": "星星·逆位", "tip": "被动 · 每回合一次", "desc": "每回合一次,兵/卒可无代价向后移动一格(不消耗行动)", "cat": "棋子"},
	...
	{"id": "shenpan2", "name": "审判·逆位", "tip": "被动", "desc": "每回合使敌方失去一个技能并重新随机抽取", "cat": "全局"},

...
const PERKS_NORMAL := [
	...
	{"id": "siwang", "name": "死亡", "tip": "主动 · 被吃充能3", "desc": "指定对方一子进入死亡状态2回合(到期摧毁,移动解毒)", "cat": "全局"},
...
const PERKS_ADVANCED := [
	...
	{"id": "lianren2", "name": "恋人·逆位", "tip": "主动 · 被吃充能2", "desc": "己方每被吃1子充能1点(需2点),使用后己方其他技能全部完成冷却/充能", "cat": "全局"},
	...
	{"id": "siwang2", "name": "死亡·逆位", "tip": "主动 · 被吃充能4", "desc": "下回合移动的非己方棋子进入死亡状态3回合(到期摧毁,移动解毒)", "cat": "全局"},
	{"id": "jiezhi2", "name": "节制·逆位", "tip": "主动 · 2回合", "desc": "这回合追加一次行动,跳过下回合", "cat": "全局"},
